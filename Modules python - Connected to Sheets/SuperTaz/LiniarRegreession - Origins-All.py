...
origins_map_work_das=das_work.groupby('prev_stop_zone')['person_id'].count()
origins_map_shop_das=das_shop.groupby('prev_stop_zone')['person_id'].count()
origins_map_edu_das=das_edu.groupby('prev_stop_zone')['person_id'].count()
origins_map_other_das=das_other.groupby('prev_stop_zone')['person_id'].count()
...
axe.set_title('Linear regression - All stops to Work - origin ' ,fontsize=25)
axe.set_xlabel('SimMobility ' , fontsize=25,labelpad=15)
axe.set_ylabel('THS ', fontsize=25,labelpad=15)
axe.set_xlim(0, 175000)
axe.set_ylim(0, 175000)
axe.text(10000, 100000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe.text(10000, 120000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe2.set_title('Linear regression - All stops to Education - origin ' ,fontsize=25)
axe2.set_xlabel('SimMobility ' , fontsize=25,labelpad=15)
axe2.set_ylabel('THS ', fontsize=25,labelpad=15)
axe2.set_xlim(0, 100000)
axe2.set_ylim(0, 100000)
axe2.text(2000, 80000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe2.text(2000, 60000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe3.set_title('Linear regression - All stops to Other - origin ' ,fontsize=25)
...
axe4.set_title('Linear regression - All stops to Shop - origin ' ,fontsize=25)
axe4.set_xlabel('SimMobility ' , fontsize=25,labelpad=15)
axe4.set_ylabel('THS ', fontsize=25,labelpad=15)
axe4.set_xlim(0, 75000)
axe4.set_ylim(0, 75000)
axe4.text(10000, 60000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe4.text(10000, 70000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
request = service.spreadsheets().values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="All-Stops-Origins!A2:D1000", valueInputOption="USER_ENTERED", body={"values":merge_stops_work_list}).execute()

request = service.spreadsheets().values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="All-Stops-Origins!K2:M1000", valueInputOption="USER_ENTERED", body={"values":merge_stops_shop_list}).execute()


request = service.spreadsheets().values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="All-Stops-Origins!U2:W1000", valueInputOption="USER_ENTERED", body={"values":merge_stops_edu_list}).execute()

request = service.spreadsheets().values().update(spreadsheetId=SAMPLE_SPREADSHEET_ID, range="All-Stops-Origins!AE2:AG1000", valueInputOption="USER_ENTERED", body={"values":merge_stops_other_list}).execute()
