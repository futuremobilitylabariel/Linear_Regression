...
axe.text(8000, 7000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe.text(8000, 6000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe2.set_xlim(0, 17500)
axe2.set_ylim(0, 17500)
axe2.text(1000, 10000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe2.text(1000, 12000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe3.text(17500, 6500, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe3.text(16500, 4500, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe4.set_xlim(0, 5000)
axe4.set_ylim(0, 5000)
axe4.text(1000, 4000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe4.text(1000, 3000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe.set_xlim(0, 8000)
axe.set_ylim(0, 8000)
axe.text(3000, 7000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe.text(3000, 6000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
axe.tick_params(axis='x', rotation=0,labelsize=18)
axe.tick_params(axis='y', rotation=0,labelsize=18)
