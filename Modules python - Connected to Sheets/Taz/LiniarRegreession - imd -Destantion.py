...
axe.set_xlim(0, 25000)
axe.set_ylim(0, 25000)
...
axe2.set_xlim(0, 800)
axe2.set_ylim(0, 800)
axe2.text(200 ,500, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe2.text(200, 400, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
...
axe3.set_xlim(0, 17500)
axe3.set_ylim(0, 17500)
...
axe4.set_xlim(0, 8000)
axe4.set_ylim(0, 8000)
axe4.text(2000, 4000, 'R-squared = %0.2f' % r2_score(Y1, Y1_pred),size=17)
axe4.text(2000, 3000, 'Coefficients = %0.2f' % linear_regressor1.coef_,size=17)
